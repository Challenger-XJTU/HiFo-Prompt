...
class GetPrompts():
    def __init__(self):
        self.prompt_task = "I have n jobs and m machines. Help me create a sophisticated algorithm to update the execution time matrix and select the top jobs to perturb to avoid being trapped in the local optimum scheduling \
